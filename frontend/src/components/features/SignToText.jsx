...
const SignToText = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const response = await fetch('http://your-backend-api/sign-to-text', {
        method: 'POST',
        body: formData,
      });
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold mb-4">Sign Language to Text Converter</h1>
        <p className={theme === 'dark' ? 'text-gray-300' : 'text-gray-600'}>
          Record or upload a sign language video and our AI will convert it to text.
        </p>
      </div>
